...
| Current/available balance | **REQUIRED + STORE** | Core to "how much do we have left" (CLAUDE.md's first product question) — this is a monetary figure, not identity/account metadata, and carries none of the sensitivity this audit is targeting. |
